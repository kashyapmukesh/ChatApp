...
def connect():
    ...
    try:
        ...
        messagebox.showerror("Unable to connect to server", f"Unable to connect the server {HOST} {PORT}")

    username = username_textbox.get()
    if username != '':
        client.sendall(username.encode())
    else:
        messagebox.showerror("Invalid user name","Username cannot be empty")
...
def send_message():
    ...
    if message != '':
        ...
        messagebox.showerror("Empty message","Empty cannot be empty")
